    ...
    try:
        ...
        write_runtime_status(
            BASE_DIR,
            {
                ...
                "mensagem": "Comparação com SQL Server concluída.",
                "orientacao": "",
            },
        )
        ...
        # Importante:
        # não lança a exceção novamente.
        # Assim o Handler NÃO move os arquivos para a pasta de erros.
        # Eles permanecem na entrada para reprocessamento manual.
        return
