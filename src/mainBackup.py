...
def process_file(file_path: str, settings):
    ...
    if fmt == "xml":
        ...
        logging.info(f"Detectado arquivo XML: {file_path}")
    ...
    # TXT que não pertence ao padrão da aplicação
    if info is None:
    ...
    # =====================================================
    # NFLOG
    # Mantém exatamente a rotina atual
    # =====================================================
    ...
    # =====================================================
    # LOGCONF / CONFPROD
    # Nesta primeira etapa apenas reconhecemos o par.
    # Nenhuma alteração será feita no SQL Server ainda.
    # =====================================================
    ...
    # espera os dois terminarem de ser copiados
...
class Handler(FileSystemEventHandler):
    ...
    def _processar_evento(self, file_path: str):
        ...
        # Mesmo arquivo, mesmo tamanho e mesma data de modificação:
        # é apenas evento duplicado do watchdog.
        ...
        try:
            ...
            # Registra a assinatura FINAL do arquivo,
            # depois que process_file terminou.
            assinatura_final = self._assinatura_arquivo(file_path)
