...
APP_TITLE = "Movimentações de Estoque - 2A Tecnologia"
...
class MovimentosViewer(tk.Tk):
    def __init__(self, num_documento=None):
        ...
        self.after(20, self._remove_titlebar_icon)
        self.after(120, self.refresh)

    def _remove_titlebar_icon(self):
        """Remove o ícone da barra de título no Windows sem alterar os botões da janela."""
        if os.name != "nt":
            return
        try:
            import ctypes
